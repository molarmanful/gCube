...
//gcube.js start
var GCube;!function(t){function e(t){var e=[];return t.trim().replace(/{|}|\[|\]\(|\)/g,"").split(/\s+/).forEach(function(t){2===t.length?e.push("2"===t[1]?new ERNO.Twist(t[0],180):t[0].toLowerCase()):3===t.length?e.push(new ERNO.Twist(t[0].toLowerCase(),180)):1===t.length&&e.push(t[0])}),e}function i(t){var e=[];return t.trim().replace(/{|}|\[|\]\(|\)/g,"").split(/\s+/).reverse().forEach(function(t){2===t.length?e.push("2"===t[1]?new ERNO.Twist(t[0].toLowerCase(),180):t[0].toUpperCase()):3===t.length?e.push(new ERNO.Twist(t[0].toUpperCase(),180)):1===t.length&&e.push(t[0].toLowerCase())}),e}var n={edges:function(){this.edges.showStickers(),this.centers.hideStickers(),this.corners.hideStickers()},corners:function(){this.corners.showStickers(),this.edges.hideStickers(),this.centers.hideStickers()},centers:function(){this.centers.showStickers(),this.edges.hideStickers(),this.corners.hideStickers()},flcross:function(){this.down.cross.showStickers(),this.centers.showStickers(),this.rotation.x=100},flxcross:function(){this.down.cross.showStickers(),this.centers.showStickers(),this.hasId(5).showStickers(),this.hasId(8).showStickers(),this.rotation.x=100},fl:function(){this.down.showStickers(),this.centers.showStickers(),this.rotation.x=100},cfl:function(){this.down.corners.showStickers(),this.rotation.x=100},belt:function(){this.equator.showStickers(),this.centers.showStickers()},f2l:function(){this.showStickers(),this.up.hideStickers(),this.centers.showStickers(),this.rotation.x=100},oll:function(){this.showEdgeStickersOnUpFace(),this.showCornerStickersOnUpFace(),this.centers.showStickers(),this.equator.showStickers(),this.down.showStickers()},eoll:function(){this.showEdgeStickersOnUpFace(),this.centers.showStickers(),this.equator.showStickers(),this.down.showStickers()},ocll:function(){this.showCornerStickersOnUpFace(),this.centers.showStickers(),this.equator.showStickers(),this.down.showStickers()},coll:function(){this.showEdgeStickersOnUpFace(),this.centers.showStickers(),this.up.corners.showStickers(),this.equator.showStickers(),this.down.showStickers()},cll:function(){this.showStickers(),this.up.edges.hideStickers()},"2x2x2":function(){this.showStickers(),this.up.hideStickers(),this.back.hideStickers(),this.left.hideStickers(),this.centers.showStickers(),this.rotation.x=100},"2x2x3":function(){this.showStickers(),this.up.hideStickers(),this.back.hideStickers(),this.centers.showStickers(),this.rotation.x=100},eoline:function(){this.showStickers(),this.up.hideStickers(),this.left.hideStickers(),this.right.hideStickers(),this.centers.showStickers(),this.rotation.x=100},fb:function(){this.right.showStickers(),this.up.hideStickers(),this.rotation.x=100},f2b:function(){this.right.showStickers(),this.left.showStickers(),this.up.hideStickers(),this.rotation.x=100},cmll:function(){this.right.showStickers(),this.left.showStickers(),this.up.hideStickers(),this.up.corners.showStickers()}};GCube=function(e){this.element=t(e),this.cube=new ERNO.Cube,this.cube.keyboardControlsEnabled=!1,this.cube.core.setOpacity(0),this.container=t('<div class="cubecont"/>'),this.boundingBox=t('<div class="cube-bounding-box"/>'),this.boundingBox.append(this.cube.domElement),this.container.append(this.boundingBox),this.element.append(this.container)},GCube.prototype={setup:function(){var t=this.element.find("g-speed").text(),e=this.element.find("g-scramble").text(),i=this.element.find("g-algorithm").text(),n=this.element.find("g-highlight").text(),r=this.element.find("g-text").text(),s=this.element.find("g-florian").text();return angle=this.element.find("g-angle").text().split(","),this.gspeed(t).gscramble(e).galgorithm(i).ghighlight(n).gtext(r).gflorian(s).gangle([angle[0]],[angle[1]],[angle[2]]),this},gspeed:function(t){return"number"==typeof t?this.cube.twistDuration=t:"string"==typeof t&&t.length>0?this.cube.twistDuration=parseFloat(t):this.cube.twistDuration=10,this},gscramble:function(t){if("string"==typeof t&&t.length>0){var i=e(t.replace(/\/random/i,"").replace(/\/2-genR/i,"").replace(/\/2-genL/i,"").replace(/\/2-genM/i,"").replace(/\/3-genRF/i,"").replace(/\/3-genLF/i,"").replace(/\/3-genRL/i,""));t.match("/random")?(t.match("/2-genR")?this.cube.shuffleMethod="RrUu":t.match("/2-genM")?this.cube.shuffleMethod="MmUu":t.match("/2-genL")?this.cube.shuffleMethod="RrUu":t.match("/3-genRF")?this.cube.shuffleMethod="RrUuFf":t.match("/3-genLF")?this.cube.shuffleMethod="LlUuFf":t.match("/3-genRL")?this.cube.shuffleMethod="RrUuLl":this.cube.shuffleMethod="RrLlUuDdFfBb",this.cube.shuffle(25)):this.cube.twist(i)}return this},galgorithm:function(n){if("string"==typeof n&&n.length>0){var r=e(n),s=i(n);this.cube.mouseControlsEnabled=!1,this.container.children(".algorithmControls").remove();var o=t('<div class="algorithmControls">'),a=t('<button class="playalg">');a.text("Play Algorithm"),o.append(a),o.append(t("<br/>"));var h=t("<span>");h.text("Speed:"),o.append(h);var c=t('<input class="speedslider" type="range">');c.attr("min","10"),c.attr("max","1500"),c.attr("value","500"),o.append(c),this.container.prepend(o);var u=this,l=!1;a.click(function(){l?(l=!1,u.cube.twistDuration=10,u.cube.twist(s),a.text("Play Algorithm")):(l=!0,u.cube.twistDuration=parseInt(c.val()),a.text("Reverse Algorithm"),u.cube.twist(r))})}return this},ghighlight:function(t){return"string"==typeof t&&t.length>0&&(this.cube.hideStickers(),t=t.toLowerCase(),n.hasOwnProperty(t)?n[t].apply(this.cube):this.cube.showStickers()),this},gtext:function(t){return"string"==typeof t&&t.length>0&&(this.cube.showTexts(),this.cube.folds[0].setText(t),this.cube.folds[1].setText(""),this.cube.folds[2].setText(""),this.cube.rotation.x=50.2),this},gflorian:function(t){var e,i="0",n="0";return"string"==typeof t&&t.match(",")&&(e=t.replace(/\s/g).split(","),i=e[0],n=e[1]),this.container.children("style").remove(),this.container.prepend("<style>.cube .cubeletId-0 .faceFront .sticker {  border-radius: "+n+" "+n+" "+i+" "+n+";}.cube .cubeletId-0 .faceUp .sticker {  border-radius: "+n+" "+i+" "+n+" "+n+";}.cube .cubeletId-0 .faceLeft .sticker {  border-radius: "+i+" "+n+" "+n+" "+n+";}.cube .cubeletId-1 .faceFront .sticker {  border-radius: "+n+" "+n+" "+i+" "+i+";}.cube .cubeletId-1 .faceUp .sticker {  border-radius: "+i+" "+i+" "+n+" "+n+";}.cube .cubeletId-2 .faceFront .sticker {  border-radius: "+n+" "+n+" "+n+" "+i+";}.cube .cubeletId-2 .faceUp .sticker {  border-radius: "+n+" "+i+" "+n+" "+n+";}.cube .cubeletId-2 .faceRight .sticker {  border-radius: "+n+" "+n+" "+i+" "+n+";}.cube .cubeletId-3 .faceFront .sticker {  border-radius: "+n+" "+i+" "+i+" "+n+";}.cube .cubeletId-3 .faceLeft .sticker {  border-radius: "+i+" "+i+" "+n+" "+n+";}.cube .cubeletId-4 .faceFront .sticker {  border-radius: "+i+";}.cube .cubeletId-5 .faceFront .sticker {  border-radius: "+i+" "+n+" "+n+" "+i+";}.cube .cubeletId-5 .faceRight .sticker {  border-radius: "+n+" "+i+" "+i+" "+n+";}.cube .cubeletId-6 .faceFront .sticker {  border-radius: "+n+" "+i+" "+n+" "+n+";}.cube .cubeletId-6 .faceDown .sticker {  border-radius: "+n+" "+i+" "+n+" "+n+";}.cube .cubeletId-6 .faceLeft .sticker {  border-radius: "+n+" "+i+" "+n+" "+n+";}.cube .cubeletId-7 .faceFront .sticker {  border-radius: "+i+" "+i+" "+n+" "+n+";}.cube .cubeletId-7 .faceDown .sticker {  border-radius: "+n+" "+i+" "+i+" "+n+";}.cube .cubeletId-8 .faceFront .sticker {  border-radius: "+i+" "+n+" "+n+" "+n+";}.cube .cubeletId-8 .faceDown .sticker {  border-radius: "+n+" "+n+" "+i+" "+n+";}.cube .cubeletId-8 .faceRight .sticker {  border-radius: "+n+" "+i+" "+n+" "+n+";}.cube .cubeletId-9 .faceUp .sticker {  border-radius: "+n+" "+i+" "+i+" "+n+";}.cube .cubeletId-9 .faceLeft .sticker {  border-radius: "+i+" "+n+" "+n+" "+i+";}.cube .cubeletId-10 .faceUp .sticker {  border-radius: "+i+";}.cube .cubeletId-11 .faceUp .sticker {  border-radius: "+i+" "+n+" "+n+" "+i+";}.cube .cubeletId-11 .faceRight .sticker {  border-radius: "+n+" "+n+" "+i+" "+i+";}.cube .cubeletId-12 .faceLeft .sticker {  border-radius: "+i+";}.cube .cubeletId-14 .faceRight .sticker {  border-radius: "+i+";}.cube .cubeletId-15 .faceDown .sticker {  border-radius: "+i+" "+i+" "+n+" "+n+";}.cube .cubeletId-15 .faceLeft .sticker {  border-radius: "+n+" "+i+" "+i+" "+n+";}.cube .cubeletId-16 .faceDown .sticker {  border-radius: "+i+";}.cube .cubeletId-17 .faceDown .sticker {  border-radius: "+n+" "+n+" "+i+" "+i+";}.cube .cubeletId-17 .faceRight .sticker {  border-radius: "+i+" "+i+" "+n+" "+n+";}.cube .cubeletId-18 .faceBack .sticker {  border-radius: "+i+" "+n+" "+n+" "+n+";}.cube .cubeletId-18 .faceUp .sticker {  border-radius: "+n+" "+n+" "+i+" "+n+";}.cube .cubeletId-18 .faceLeft .sticker {  border-radius: "+n+" "+n+" "+n+" "+i+";}.cube .cubeletId-19 .faceUp .sticker {  border-radius: "+n+" "+n+" "+i+" "+i+";}.cube .cubeletId-19 .faceBack .sticker {  border-radius: "+i+" "+n+" "+n+" "+i+";}.cube .cubeletId-20 .faceUp .sticker {  border-radius: "+n+" "+n+" "+n+" "+i+";}.cube .cubeletId-20 .faceBack .sticker {  border-radius: "+n+" "+n+" "+n+" "+i+";}.cube .cubeletId-20 .faceRight .sticker {  border-radius: "+n+" "+n+" "+n+" "+i+";}.cube .cubeletId-21 .faceBack .sticker {  border-radius: "+i+" "+i+" "+n+" "+n+";}.cube .cubeletId-21 .faceLeft .sticker {  border-radius: "+n+" "+n+" "+i+" "+i+";}.cube .cubeletId-22 .faceBack .sticker {  border-radius: "+i+";}.cube .cubeletId-23 .faceBack .sticker {  border-radius: "+n+" "+n+" "+i+" "+i+";}.cube .cubeletId-23 .faceRight .sticker {  border-radius: "+i+" "+n+" "+n+" "+i+";}.cube .cubeletId-24 .faceBack .sticker {  border-radius: "+n+" "+i+" "+n+" "+n+";}.cube .cubeletId-24 .faceDown .sticker {  border-radius: "+i+" "+n+" "+n+" "+n+";}.cube .cubeletId-24 .faceLeft .sticker {  border-radius: "+n+" "+n+" "+i+" "+n+";}.cube .cubeletId-25 .faceBack .sticker {  border-radius: "+n+" "+i+" "+i+" "+n+";}.cube .cubeletId-25 .faceDown .sticker {  border-radius: "+i+" "+n+" "+n+" "+i+";}.cube .cubeletId-26 .faceRight .sticker {  border-radius: "+i+" "+n+" "+n+" "+n+";}.cube .cubeletId-26 .faceDown .sticker {  border-radius: "+n+" "+n+" "+n+" "+i+";}.cube .cubeletId-26 .faceBack .sticker {  border-radius: "+n+" "+n+" "+i+" "+n+";}</style>"),this},gangle:function(t,e,i){this.rotation={x:0|t,y:(0|e)+.8,z:0|i}}},ERNO.extend(ERNO.Cube.prototype,{showEdgeStickersOnUpFace:function(){var e=this;requestAnimationFrame(function(){var i=t(e.domElement).find(".cubeletId-1, .cubeletId-11, .cubeletId-19, .cubeletId-9"),n=i.find(".sticker.orange");n.css("display","block")})},showCornerStickersOnUpFace:function(){var e=this;requestAnimationFrame(function(){var i=t(e.domElement).find(".cubeletId-0, .cubeletId-2, .cubeletId-20, .cubeletId-18"),n=i.find(".sticker.orange");n.css("display","block")})}}),GCube.setupAllGcubes=function(){t("g-cube").each(function(){new GCube(this).setup()})};var r=t('<link rel="stylesheet" type="text/css" href="http://molarmanful.github.io/gCube/gcube.css">');r.load(function(){GCube.setupAllGcubes()}),t("head").prepend(r)}(jQuery);
