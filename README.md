...
| _highlight_ | String. Case-sensitive. Defaults to highlighting the whole cube. NOTE: OLL, EOLL, OCLL, and COLL stages will not work on their own. See http://codepen.io/molarmanful/pen/XJeMXQ for a workaround. |
